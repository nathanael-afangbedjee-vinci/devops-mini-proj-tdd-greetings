...
function upperCaseName(upperCaseNames, language) {
  ...
  result +=
    upperCaseNames.length > 1
      ? getConjunction(language) +
        " " +
        getUppercaseGreeting(
          upperCaseNames[upperCaseNames.length - 1],
          language,
        ) +
        "!"
      : "!";
...
function lowerCaseName(lowerCaseNames, language) {
  ...
  result +=
    lowerCaseNames.length > 1
      ? getConjunction(language) +
        " " +
        getNormalGreeting(lowerCaseNames[lowerCaseNames.length - 1], language) +
        "."
      : ".";
  return result;
}
